...
#import "PaySayAlertModel.h"

typedef void(^AlertButtonAction)(id sender);
typedef void(^AlertTableCellSelectionAction)(id sender);

@interface PaySayAlertViewController : UIViewController <UITableViewDataSource, UITableViewDelegate, UIGestureRecognizerDelegate>

// Alertview model object
@property (nonatomic, strong) PaySayAlertModel *alertModel;
...
- (void)displayAlertViewOnView:(UIView *)baseView
                     withModel:(PaySayAlertModel *)alertModel
